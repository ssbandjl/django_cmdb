...
class InfoCollection(object):
    ...
    def collect(self):
        ...
        try:
            func = getattr(self, platform.system()) #https://blog.csdn.net/zywvvd/article/details/77946233 获取操作系统类型,func=Linux/Windows
            info_data = func() #根据操作系统的不同，反射获取相应的信息收集方法，并执行
